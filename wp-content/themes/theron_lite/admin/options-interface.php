...
function theron_fields() {
	...
	foreach ( $options as $value ) {
		...
		// Uploader
		case "upload":
			$output .= theron_medialibrary_uploader( $value['id'], $val, null );
			break;
		...
		case 'background':
			...
			$output .= theron_medialibrary_uploader( $value['id'], $background['image'], null, '',0,'image');
