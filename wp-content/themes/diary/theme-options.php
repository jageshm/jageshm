...
$args['menu_title'] = __('Diary', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Diary', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'std' => '<a href="'.get_bloginfo('url').'/" title="'.get_bloginfo('description').'" rel="nofollow">'.get_bloginfo('name').'</a> Copyright &copy; '.date("Y").'. Theme by <a href="http://mythemeshop.com/" target="_blank">MyThemeShop</a>.'
						),
					array(
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'sub_desc' => __('Boxline Theme comes with unlimited color schemes for your theme\'s styling.', 'nhp-opts'),
						'std' => '#D83C3C'
						),
					array(
